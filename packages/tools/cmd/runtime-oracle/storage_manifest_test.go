...
func TestStorageSelectionBaselinePinsSaveRegionCases(t *testing.T) {
	...
	wantSaveCases := map[string]bool{
		...
		"save.region/1/encode/capacity-minus-one":                true,
		...
		"save.world-metadata/1/decode/truncated-record":            true,
		"save.world-metadata/1/decode/v1-canonical":                true,
		"save.world-metadata/2/decode/truncated-record":            true,
		"save.world-metadata/2/decode/v2-canonical":                true,
		"save.world-metadata/3/decode/truncated-record":            true,
		"save.world-metadata/3/decode/v3-canonical":                true,
		"save.world-metadata/4/decode/truncated-record":            true,
		...
		"save.world-metadata/6/decode/v6-boundary":                 true,
		"save.world-metadata/6/decode/v6-weather-255":              true,
		"save.world-metadata/6/decode/wrong-header":                true,
		"save.world-metadata/6/encode/capacity-minus-one":          true,
		...
		"save.chunk/4/decode/insufficient-drop-slots":              true,
		...
		"save.chunk/9/decode/active-container-mismatch":            true,
		"save.chunk/9/decode/checksum":                             true,
		"save.chunk/9/decode/compressed-oversize":                  true,
		"save.chunk/9/decode/declared-logical-oversize":            true,
		"save.chunk/9/decode/invalid-version-future":               true,
		"save.chunk/9/decode/invalid-version-zero":                 true,
		"save.chunk/9/decode/palette-error":                        true,
		"save.chunk/9/decode/rust-v9-frame":                        true,
		"save.chunk/9/decode/trailing-byte":                        true,
		"save.chunk/9/decode/truncated-envelope":                   true,
		"save.chunk/9/decode/truncated-frame":                      true,
		"save.chunk/9/decode/truncated-payload":                    true,
		"save.chunk/9/decode/v9-fixture":                           true,
		"save.chunk/9/decode/wrong-key":                            true,
		"save.chunk/9/decode/wrong-revision":                       true,
